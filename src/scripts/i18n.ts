...
export const dictionaries = {
  zh: {
    ...
    menu_matrix_toggle: "🟢 切换 Matrix 代码雨",

    badge_status: "MMU 人工智能专业毕业生 | CGPA 3.74",
    hero_badge: "MMU 人工智能专业毕业生 | CGPA 3.74",
    hero_title: "Full-Stack Developer with a Deep Passion for AI",
    hero_desc: "我是 <strong>林伟健 (Lim Wei Jian)</strong>，一名热衷于全栈开发与 AI 的 MMU 毕业生 (CGPA 3.74)。不管是 C++、Python 还是 TypeScript，我都喜欢把各种想法变成顺手好用的软件。欢迎随便逛逛！",
    btn_skills: "探索技能实验室 🚀",
    btn_workflow: "体验 AI 工作流 🤖",
    ...
    copyright: "© 2026 林伟健 (Lim Wei Jian). Astro + TypeScript + Content Collections 构建。Cloudflare Pages 托管。"
  },
  en: {
    ...
    menu_matrix_toggle: "🟢 Toggle Matrix Rain",

    badge_status: "AI Graduate @ MMU | CGPA 3.74",
    hero_badge: "AI Graduate @ MMU | CGPA 3.74",
    hero_title: "Full-Stack Developer with a Deep Passion for AI",
    hero_desc: "I'm <strong>Lim Wei Jian</strong>, an AI Graduate from MMU (CGPA 3.74) with a deep passion for full-stack engineering. Whether it's C++, Python, or TypeScript, I just enjoy turning ideas into smooth, useful software. Take a look around!",
    btn_skills: "Explore Skill Studio 🚀",
    btn_workflow: "Try AI Workflow 🤖",
    ...
    section_n8n_title: "🤖 n8n AI Story Generator",
    section_n8n_subtitle: "Input a prompt and observe how multi-agent workflow nodes transform it into a narrative",
    n8n_placeholder: "Enter story prompt (e.g. A developer discovers a hidden AI node at midnight...)",
    ...
    footer_title: "Ready to Build the Next Great System Together?",
    footer_subtitle: "Currently open for opportunities in AI Engineering, Multi-Agent RAG, and Full-Stack Development.",
    copyright: "© 2026 Lim Wei Jian. Built with Astro + TypeScript + Content Collections. Hosted on Cloudflare Pages."
  }
};
